...
namespace WebRequest.Elegant
{
    ...
    public interface IWebRequest
    {
        ...
        IWebRequest Method(HttpMethod method);
        ...
        IWebRequest QueryParams(Dictionary<string, string> parameters);
        ...
        IWebRequest Body(IJsonObject postBody);
    }
}
